...
class ExperienceController {
    ...
    public async updateExperience(req: Request, res: Response): Promise<void> {
        ...
        try {
            const experiencePut = await Experiences.findByIdAndUpdate(id, { experience, remoteExperience }, { new: true });
    ...
    public async deleteExperience(req: Request, res: Response): Promise<void> {
        ...
        try {
            const experience: IExperience | null = await Experiences.findByIdAndDelete(id);
