    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (!existingRecruiter) {
          return res
            .status(401)
            .json({ message: "Recruiter not found", status: 401 });
        }
        const token = JWT.SIGN({ id: existingRecruiter._id });
        if (!existingRecruiter.password) {
          return res
            .status(401)
            .json({ message: "Password is not set", status: 401 });
        }
        if (password) {
          const isPasswordValid = yield bcrypt.compare(
            password,
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        if (!recruiter) {
          return res
            .status(404)
            .json({ message: "Recruiter not found", status: 404 });
        }
  ...
  updateRecruiter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (recruiterId) {
          const updatedRecruiter = yield RecruiterModel.findByIdAndUpdate(
            recruiterId,
            req.body,
            { new: true }
          )
  ...
  deleteRecruiter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const token = req.headers.token;
        if (recruiterId) {
          const deletedRecruiter = yield RecruiterModel.findByIdAndDelete(
            recruiterId
          );
          if (!deletedRecruiter) {
            return res
        ...
        if (!confirmationCode) {
          ...
          if (confirmationCode !== (yield client.get(email)))
            return res
              .status(400)
              .json({ message: "Confirmation code is wrong." });
          yield RecruiterModel.findOneAndUpdate(
            { email },
            {
